...
public final class Launcher extends Activity implements View.OnClickListener, OnLongClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		quickShortcutsEnabled = mPrefs.getBoolean(LauncherPreferenceActivity.LAUNCHER_QUICK_SHORTCUTS, true);
	...
	// Faruq: Backported dots from Launcher2
...
.ECLAIR_MR1) { 
    ...
    private void openFolder(FolderInfo folderInfo) {
        ...
        if (folderInfo instanceof UserFolderInfo) {
            ...
            openFolder = com.helixproject.launcher.LiveFolder.fromXml(this, folderInfo);
        } else {
            return;
        }
